...
**Live demo (GitHub Pages): https://abhisheksi2o.github.io/FinTea/** - 50+ companies pre-built and
...
live source is unavailable), and publishes the JSON, the `.xlsx` files and the frontend built with
`VITE_STATIC=1`. In static mode the frontend:
