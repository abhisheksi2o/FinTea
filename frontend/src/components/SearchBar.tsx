...
export function SearchBar({ providers, provider, setProvider, years, setYears, busy, onBuild }: Props) {
    ...
    <div className="search">
      <div className="search-row">
        <div className="search-input-wrap">
          <input
            className="search-input" placeholder="Type a company name or ticker, e.g. Apple, MSFT, Infosys (INFY.NS)"
        ...
        <select value={years} onChange={(e) => setYears(Number(e.target.value))} disabled={busy} title="Projection years">
